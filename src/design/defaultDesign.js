  ...
  root: {
    props: {
      ...
      darkBackgroundGradient:
        "radial-gradient(circle at 16% 12%, rgba(212,107,140,0.14), transparent 36%), radial-gradient(circle at 86% 14%, rgba(121,163,230,0.13), transparent 44%), #0f172a",
      darkBackgroundImage: "",
      textColor: "",
      darkTextColor: "",
      fontFamily: "inherit",
...
export const DEFAULT_SITE_DESIGN = {
  ...
  settings: {
    ...
    headingFontFamily: "\"Space Grotesk\", \"Manrope\", sans-serif",
    buttonFontFamily: "\"Manrope\", \"Segoe UI\", sans-serif",
    accentColor: "#d46b8c",
    secondaryAccentColor: "#79a3e6",
    footerEnabled: true,
    ...
    footerSurface: "glass",
    vodCardStyle: "bubble",
    vodThumbnailShape: "soft",
    vodThumbnailOverlay: "clean",
    vodWatchLabel: "Watch",
    vodShowGame: true,
    vodAccentColor: "#d46b8c",
  },
  pages: [
    {
      id: "home",
      ...
      puck: {
        root: {
          props: {
            ...
            darkBackgroundColor: "#0f172a",
            darkBackgroundGradient:
              "radial-gradient(circle at 14% 12%, rgba(212,107,140,0.14), transparent 36%), radial-gradient(circle at 86% 14%, rgba(121,163,230,0.14), transparent 44%), linear-gradient(180deg, #101827 0%, #0f172a 100%)",
            darkBackgroundImage: "",
            textColor: "",
            darkTextColor: "",
            fontFamily: "inherit",
